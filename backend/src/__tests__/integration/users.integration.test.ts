  ...
  describe('User CRUD Operations', () => {
    ...
    describe('GET /api/users - List Users', () => {
      ...
      it('should only show users from same company', async () => {
        ...
        const allFromSameCompany = response.body.data.every(
          (user: any) => user.companyId === company1.company.id
        );
    ...
    describe('PUT /api/users/:id - Update User', () => {
      it('should allow user to update their own profile', async () => {
        ...
        const response = await authenticatedRequest(app, company1User.token)
