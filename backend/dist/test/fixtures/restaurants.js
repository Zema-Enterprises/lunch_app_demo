...
exports.testRestaurants = void 0;
exports.getTestRestaurant = getTestRestaurant;
exports.getAllTestRestaurants = getAllTestRestaurants;
exports.getTestRestaurantNames = getTestRestaurantNames;
 ...
 */
function getTestRestaurant(key) {
    return exports.testRestaurants[key];
}
/**
 * Get all test restaurants
 */
function getAllTestRestaurants() {
    return Object.values(exports.testRestaurants);
}
/**
 * Get restaurant names only
 */
function getTestRestaurantNames() {
    return Object.values(exports.testRestaurants).map(r => r.name);
}
